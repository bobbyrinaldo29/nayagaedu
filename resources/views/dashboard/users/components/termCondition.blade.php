    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h1>General Terms</h1>
                <p class="p8">
                    <span class="s1">By accessing and placing an order with <a></a>, you
                        confirm that you are in agreement with and bound by
                        the terms of service contained in the Terms &amp;
                        Conditions outlined below. These terms apply to the
                        entire website and any email or other type of
                        communication between you and <a></a>. <br /><br />
                        Under no circumstances shall <a></a> team be liable
                        ...
                        even if <a></a> team or an authorized representative
                        has been advised of the possibility of such damages.
                        If your use of materials from this site results in
                        the need for servicing, repair or correction of
                        equipment or data, you assume any costs thereof.
                        <br /><br />
                        <a></a> will not be responsible for any outcome that
                ...
                <h1>License</h1>
                <p class="p10">
                    <span class="s1"><a>Nayaga Edu</a> grants you a revocable,
                        non-exclusive, non- transferable, limited license to
                        download, install and use our service strictly in
                        accordance with the terms of this Agreement.
                        <br /><br />
                        These Terms &amp; Conditions are a contract between
                        you and <a>Nayaga Edu</a> (referred to in these
                        Terms &amp; Conditions as "<a>Nayaga Edu</a>", "us",
                        "we" or "our"), the provider of the
                        <a>Nayaga Edu</a> website and the services
                        accessible from the <a>Nayaga Edu</a> website (which
                        are collectively referred to in these Terms &amp;
                        Conditions as the "<a>Nayaga Edu</a> Service").
                        <br /><br />
                        You are agreeing to be bound by these Terms &amp;
                        Conditions. If you do not agree to these Terms &amp;
                        Conditions, please do not use the Service. In these
                        Terms &amp; Conditions, "you" refers both to you as
                        an individual and to the entity you represent. If
                        you violate any of these Terms &amp; Conditions, we
                        reserve the right to cancel your account or block
                        access to your account without notice.</span>
                </p>
                ...
                <ul class="ul1">
                    <li class="li8">
                        <span class="s1"><strong>Cookie:</strong> small amount of data
                    ...
                    <li class="li8">
                        <span class="s1"><strong>Company:</strong> when this policy
                            mentions “Company,” “we,” “us,” or “our,” it
                            refers to <a>Nayaga Edu</a>,
                            <a>Jl. Asia Afrika 133-137</a> that is responsible
                            for your information under this Privacy Policy.<br /></span>
                    </li>
                    <!---->
                    <li class="li8">
                        <span class="s1"><strong>Country:</strong> where
                            <a>Nayaga Edu</a> or the owners/founders of
                            <a>Nayaga Edu</a> are based, in this case is
                            <a>Indonesia</a>.<br /></span>
                    </li>
                    <li class="li8">
                        <span class="s1"><strong>Customer:</strong> refers to the company,
                            organization or person that signs up to use the
                            <a>Nayaga Edu</a> Service to manage the
                            relationships with your consumers or service
                            users.<br /></span>
                    </li>
                    <li class="li8">
                        <span class="s1"><strong>Device:</strong> any internet connected
                            device such as a phone, tablet, computer or any
                            other device that can be used to visit
                            <a>Nayaga Edu</a> and use the services.<br /></span>
                    </li>
                    <li class="li8">
                        <span class="s1"><strong>IP address:</strong> Every device
                            connected to the Internet is assigned a number
                            known as an Internet protocol (IP) address. These
                            numbers are usually assigned in geographic blocks.
                            An IP address can often be used to identify the
                            location from which a device is connecting to the
                            Internet.<br /></span>
                    </li>
                    <li class="li8">
                        <span class="s1"><strong>Personnel:</strong> refers to those
                            individuals who are employed by
                            <a>Nayaga Edu</a> or are under contract to perform
                            a service on behalf of one of the parties.<br /></span>
                    </li>
                    <li class="li8">
                        <span class="s1"><strong>Personal Data:</strong> any information
                    ...
                    <li class="li8">
                        <span class="s1"><strong>Service:</strong> refers to the service
                            provided by <a>Nayaga Edu</a> as described in the
                            relative terms (if available) and on this
                            platform.<br /></span>
                    </li>
                    <li class="li8">
                        <span class="s1"><strong>Third-party service:</strong> refers to
                            ...
                            interest you.<br /></span>
                    </li>
                    <li class="li8">
                        <span class="s1"><strong>Website:</strong> <a>Nayaga Edu</a>’s
                            site, which can be accessed via this URL:
                            <a>___________</a><br /></span>
                    </li>
                    <li class="li8">
                        <span class="s1"><strong>You:</strong> a person or entity that is
                            registered with <a>Nayaga Edu</a> to use the
                            Services.<br /></span>
                    </li>
                </ul>
                <h1>Restrictions</h1>
                <p class="p10">
                    <span class="s1">You agree not to, and you will not permit others
                        to:</span>
                </p>
                <ul class="ul1">
                    <li class="li11">
                        <span class="s3">License, sell, rent, lease, assign, distribute,
                            transmit, host, outsource, disclose or otherwise
                            commercially exploit the service or make the
                            platform available to any third party.</span>
                    </li>
                    <li class="li11">
                        <span class="s3">Modify, make derivative works of, disassemble,
                            decrypt, reverse compile or reverse engineer any
                            part of the service.</span>
                    </li>
                    <li class="li11">
                        <span class="s3">Remove, alter or obscure any proprietary notice
                            (including any notice of copyright or trademark)
                            of or its affiliates, partners, suppliers or the
                            licensors of the service.</span>
                    </li>
                </ul>
                
                <h1>Payment</h1>
                <p class="p10">
                    <span class="s1">If you register to any of our recurring payment
                        ...
                        provide us with a valid credit card (Visa,
                        ...
                        By providing us with your credit card number and
                        associated payment information, you agree that we
                        are authorized to verify information immediately,
                        and subsequently invoice your account for all fees
                        and charges due and payable to us hereunder and that
                        no additional notice or consent is required. You
                        agree to immediately notify us of any change in your
                        billing address or the credit card used for payment
                        hereunder. We reserve the right at any time to
                        change its prices and billing methods, either
                        immediately upon posting on our Site or by e-mail
                        ...
                        by you. No contract will exist between you and us
                        for the Service until we accept your order by a
                        confirmatory e-mail, SMS/MMS message, or other
                        appropriate means of communication. You are
                        responsible for any third-party fees that you may
                        incur when using the Service.</span>
                </p>
                <!---->
                <!---->
                ...
                <p class="p10">
                    <span class="s1">Thanks for shopping with us. We appreciate the fact
                        that you like to buy the stuff we build. We also
                        want to make sure you have a rewarding experience
                        while you’re exploring, evaluating, and purchasing
                        our products.<br />
                        As with any shopping experience, there are terms and
                        conditions that apply to transactions at our
                        company. We’ll be as brief as our attorneys will
                        allow. The main thing to remember is that by placing
                        an order or making a purchase from us, you agree to
                        the terms along with our Privacy Policy.<br />
                        ...
                        the issues you are going through with our
                        product.</span>
                </p>
                
                <h1>Your Suggestions</h1>
                <p class="p10">
                    <span class="s1">Any feedback, comments, ideas, improvements or
                        suggestions (collectively, "Suggestions") provided
                        by you to us with respect to the service shall
                        remain the sole and exclusive property of us. We
                        shall be free to use, copy, modify, publish, or
                        redistribute the Suggestions for any purpose and in
                        any way without any credit or any compensation to
                        you.</span>
                </p>
                
                <h1>Your Consent</h1>
                <p class="p10">
                    <span class="s1">We've updated our Terms &amp; Conditions to provide
                        you with complete transparency into what is being
                        set when you visit our site and how it's being used.
                        By using our service, registering an account, or
                ...
                <p class="p10">
                    <span class="s1">Our service may contain links to other websites
                        that are not operated by Us. If You click on a third
                        party link, You will be directed to that third
                        party's site. We strongly advise You to review the
                        Terms &amp; Conditions of every site You visit. We
                        have no control over and assume no responsibility
                        for the content, Terms &amp; Conditions or practices
                        of any third party sites or services.</span>
                </p>
                
                <h1>Cookies</h1>
                <p class="p10">
                    <span class="s1">We use "Cookies" to identify the areas of our
                        ...
                        service but are non-essential to their use. However,
                        ...
                        visit our platform as we would not be able to
                ...
                <p class="p10">
                    <span class="s1">You acknowledge and agree that we may stop
                        ...
                        your account details or any files or other materials
                        which is contained in your account. If we decide to
                        change our Terms &amp; Conditions, we will post
                        those changes on this page, and/or update the Terms
                        &amp; Conditions modification date below.</span>
                </p>
                
                <h1>Modifications to Our service</h1>
                <p class="p10">
                    <span class="s1">We reserve the right to modify, suspend or
                        discontinue, temporarily or permanently, the service
                        or any service to which it connects, with or without
                        notice and without liability to you.</span>
                </p>
                
                <h1>Updates to Our service</h1>
                <p class="p10">
                    <span class="s1">We may from time to time provide enhancements or
                        improvements to the features/ functionality of the
                        service, which may include patches, bug fixes,
                        updates, upgrades and other modifications
                        ("Updates"). Updates may modify or delete certain
                        features and/or functionalities of the service. You
                        ...
                        service to you. You further agree that all Updates
                        will be (i) deemed to constitute an integral part of
                        the service, and (ii) subject to the terms and
                        conditions of this Agreement.</span>
                </p>
                
                <h1>Third-Party Services</h1>
                <p class="p10">
                    <span class="s1">We may display, include or make available
                        ...
                        Party Services"). You acknowledge and agree that we
                        ...
                        thereof. We do not assume and shall not have any
                        ...
                        such third parties' terms and conditions.</span>
                </p>
                
                <h1>Term and Termination</h1>
                <p class="p10">
                    <span class="s1">This Agreement shall remain in effect until
                        terminated by you or us. We may, in its sole
                        discretion, at any time and for any or no reason,
                        suspend or terminate this Agreement with or without
                        prior notice. This Agreement will terminate
                        immediately, without prior notice from us, in the
                        event that you fail to comply with any provision of
                        this Agreement. You may also terminate this
                        Agreement by deleting the service and all copies
                        thereof from your computer. Upon termination of this
                        Agreement, you shall cease all use of the service
                        and delete all copies of the service from your
                        computer. Termination of this Agreement will not
                        limit any of our rights or remedies at law or in
                        equity in case of breach by you (during the term of
                        this Agreement) of any of your obligations under the
                        present Agreement.</span>
                </p>
                
                <h1>Term and Termination</h1>
                <p class="p10">
                    <span class="s1">If you are a copyright owner or such owner’s agent
                        and believe any material from us constitutes an
                ...
                <p class="p10">
                    <span class="s1">You agree to indemnify and hold us and our parents,
                        subsidiaries, affiliates, officers, employees,
                        agents, partners and licensors (if any) harmless
                        from any claim or demand, including reasonable
                        attorneys' fees, due to or arising out of your: (a)
                        use of the service; (b) violation of this Agreement
                        or any law or regulation; or (c) violation of any
                        right of a third party.</span>
                </p>
                
                <h1>No Warranties</h1>
                <p class="p10">
                    <span class="s1">The service is provided to you "AS IS" and "AS
                        AVAILABLE" and with all faults and defects without
                        warranty of any kind. To the maximum extent
                        permitted under applicable law, we, on our own
                        behalf and on behalf of our affiliates and our
                        ...
                        limitation to the foregoing, we provide no warranty
                        or undertaking, and makes no representation of any
                        kind that the service will meet your requirements,
                        achieve any intended results, be compatible or work
                        with any other software, websites, systems or
                        services, operate without interruption, meet any
                        performance or reliability standards or be error
                        free or that any errors or defects can or will be
                        corrected.<br /><br />
                        Without limiting the foregoing, neither us nor any
                        ...
                        behalf of us are free of viruses, scripts, trojan
                        horses, worms, malware, timebombs or other harmful
                        components. Some jurisdictions do not allow the
                        exclusion of or limitations on implied warranties or
                        the limitations on the applicable statutory rights
                        of a consumer, so some or all of the above
                        exclusions and limitations may not apply to
                        you.</span>
                </p>
                
                <h1>Limitation of Liability</h1>
                <p class="p10">
                    <span class="s1">Notwithstanding any damages that you might incur,
                ...
                <h1>Severability</h1>
                <p class="p10">
                    <span class="s1">If any provision of this Agreement is held to be
                ...
                <h1>Waiver</h1>
                <p class="p10">
                    <span class="s1">Except as provided herein, the failure to exercise
                        ...
                        terms, the terms of this Agreement shall
                        govern.</span>
                </p>
                
                <h1>Amendments to this Agreement</h1>
                <p class="p10">
                    <span class="s1">We reserve the right, at its sole discretion, to
                        modify or replace this Agreement at any time. If a
                        ...
                        no longer authorized to use our service.</span>
                </p>
                
                <h1>Entire Agreement</h1>
                <p class="p10">
                    <span class="s1">The Agreement constitutes the entire agreement
                        ...
                        use or purchase.</span>
                </p>
                
                <h1>Updates to Our Terms</h1>
                <p class="p10">
                    <span class="s1">We may change our Service and policies, and we may
                ...
                <p class="p10">
                    <span class="s1">Our platform and its entire contents, features and
                        ...
                        thereof), are owned by us, its licensors or other
                        ...
                        the express prior written permission of us, unless
                        and except as is expressly provided in these Terms
                        &amp; Conditions. Any unauthorized use of the
                        material is prohibited.</span>
                </p>
                
                <h1>Agreement to Arbitrate</h1>
                <p class="p10">
                    <span class="s1">This section applies to any dispute EXCEPT IT
                        DOESN’T INCLUDE A DISPUTE RELATING TO CLAIMS FOR
                        INJUNCTIVE OR EQUITABLE RELIEF REGARDING THE
                        ENFORCEMENT OR VALIDITY OF YOUR OR Nayaga Edu’s
                        ...
                        agreement, whether in contract, warranty, tort,
                        statute, regulation, ordinance, or any other legal
                        or equitable basis. “Dispute” will be given the
                        broadest possible meaning allowable under law.</span>
                </p>
                
                <h1>Notice of Dispute</h1>
                <p class="p10">
                    <span class="s1">In the event of a dispute, you or us must give the
                        ...
                        email to: . We will send any Notice of Dispute to
                        you by mail to your address if we have it, or
                        otherwise to your email address. You and us will
                        attempt to resolve any dispute through informal
                        negotiation within sixty (60) days from the date the
                        Notice of Dispute is sent. After sixty (60) days,
                        you or us may commence arbitration.</span>
                </p>
                
                <h1>Binding Arbitration</h1>
                <p class="p10">
                    <span class="s1">If you and us don’t resolve any dispute by informal
                        negotiation, any other effort to resolve the dispute
                        will be conducted exclusively by binding arbitration
                        as described in this section. You are giving up the
                        right to litigate (or participate in as a party or
                        class member) all disputes in court before a judge
                        or jury. The dispute shall be settled by binding
                        arbitration in accordance with the commercial
                        arbitration rules of the American Arbitration
                        Association. Either party may seek any interim or
                        preliminary injunctive relief from any court of
                        competent jurisdiction, as necessary to protect the
                        party’s rights or property pending the completion of
                        ...
                        non-prevailing party.</span>
                </p>
                
                <h1>Submissions and Privacy</h1>
                <p class="p10">
                    <span class="s1">In the event that you submit or post any ideas,
                        ...
                        obligations with respect to such submissions or
                        ...
                        and services using such ideas.</span>
                </p>
                
                <h1>Promotions</h1>
                <p class="p10">
                    <span class="s1">We may, from time to time, include contests,
                ...
                <p class="p10">
                    <span class="s1">In the event a product and/or service is listed at
                ...
                <h1>Miscellaneous</h1>
                <p class="p10">
                    <span class="s1">If for any reason a court of competent jurisdiction
                        finds any provision or portion of these Terms &amp;
                        Conditions to be unenforceable, the remainder of
                        these Terms &amp; Conditions will continue in full
                        force and effect. Any waiver of any provision of
                        these Terms &amp; Conditions will be effective only
                        if in writing and signed by an authorized
                        representative of us. We will be entitled to
                        ...
                        We operate and control our Service from our offices
                        in . The Service is not intended for distribution to
                ...
                <h1>Disclaimer</h1>
                <p class="p10">
                    <span class="s1">We are not responsible for any content, code or any
                        ...
                        or modifications to the contents on the Service at
                        any time without prior notice.<br /><br />
                        Our Service and its contents are provided "as is"
                        and "as available" without any warranty or
                        representations of any kind, whether express or
                        implied. We are a distributor and not a publisher of
                        the content supplied by third parties; as such, our
                        exercises no editorial control over such content and
                        ...
                        provided through or accessible via our Service.
                        Without limiting the foregoing, We specifically
                        disclaim all warranties and representations in any
                        content transmitted on or in connection with our
                        Service or on sites that may appear as links on our
                        Service, or in the products provided as a part of,
                        or otherwise in connection with, our Service,
                        including without limitation any warranties of
                        merchantability, fitness for a particular purpose or
                        non-infringement of third party rights. No oral
                        advice or written information given by us or any of
                        its affiliates, employees, officers, directors,
                        agents, or the like will create a warranty. Price
                        and availability information is subject to change
                        without notice. Without limiting the foregoing, we
                        do not warrant that our Service will be
                        uninterrupted, uncorrupted, timely, or error-free.
                    </span>
                </p>
                <h1>Contact Us</h1>
                <p class="p10">
                    <span class="s1">Don't hesitate to contact us if you have any
                        questions.</span>
                </p>
                <ul class="ul1">
                    <li class="li16">
                        <span class="s3">Via Email: <a>admin@nayagaedu.com</a></span>
                    </li>
                </ul>
