...
@section('content')
    <div class="content-body">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ route('articles.update', $showArticleById->id) }}" method="POST" enctype="multipart/form-data"
                class="needs-validation" novalidate>
                @csrf
                @method('patch')
                <div class="project-page d-flex justify-content-between align-items-center flex-wrap">
                    <div class="project mb-4">
                        <h1 class="nav-link active" data-bs-toggle="tab" href="#AllStatus" role="tab">Edit Post
                        </h1>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="col-lg-12">
                        <div class="profile card card-body px-3 py-3">
                            <input type="text" class="form-control input-default" name="title"
                                placeholder="Insert title here..." value="{{ $showArticleById->title }}" required>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <textarea class="form-control textarea-content" id="editor1"
                                    ...
                                    name="content">{{ $showArticleById->content }}</textarea>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="profile-statistics">
                                            <div class="mb-2 text-center">
                                                <img src="{{ asset('images/articles') . '/' . $showArticleById->image }}"
                                                    width="200px" class="mb-2">
                                                <span>{{ $showArticleById->image }}</span>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <select class="default-select wide form-control" id="validationCustom05"
                                            ...
                                            <option selected>{{ $showArticleById->publish == '1' ? 'Publish' : 'Draft' }}</option>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <select class="default-select wide form-control" id="validationCustom05"
                                            ...
                                            <option value="{{ $showArticleById->category }}" selected>
                                                {{ $showArticleById->category }}</option>
                                    ...
                                    <div class="card-body">
                                        <div class="profile-statistics">
                                            ...
                                            <input type="text" class="form-control" name="editor"
                                                value="{{ $showArticleById->editor }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
